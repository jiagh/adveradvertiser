...
public class PublicUtil implements Serializable {
	...
	public static void mkdirHDFSFolder() throws IOException {
		...
		if (!fs.exists(new Path(Config.HDFS_LOG_KAFKA_NORMAL_HIVEFORMAT)))
			fs.mkdirs(new Path(Config.HDFS_LOG_KAFKA_NORMAL_HIVEFORMAT));
	 ...
	 * 拆除URL中的参数
	 */
	public static String splitPageUrlParameter(String pageUrl) {
