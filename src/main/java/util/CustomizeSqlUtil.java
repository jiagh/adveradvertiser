...
public class CustomizeSqlUtil {
	...
	public static HashMap<String, String> builderSql(HashMap<String, Object> sqlMap) {
		...
		builder.append(" WHERE compaigntype!=1 AND ");
	...
	public static String createTable(HashMap<String, Object> displayMap) {
		...
		String dropExistsTableSql = "DROP TABLE IF EXISTS offline_basic_analysis.customize_report_id=" + displayMap.get("id");
		mu.insertSql(dropExistsTableSql);
		String display[];
		createTableBuilder.append("CREATE TABLE offline_basic_analysis.customize_report_id=").append(displayMap.get("id")).append("(id INT(11) NOT NULL AUTO_INCREMENT ,");
